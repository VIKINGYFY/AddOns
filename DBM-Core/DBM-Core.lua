...
PForceDisable = private.isClassic and 16 or 15--When this is incremented, trigger force disable regardless of major patch
...
---@param revision number|string Either a number in the format "202101010000" (year, month, day, hour, minute) or string "20250206060600" to be auto set by packager
