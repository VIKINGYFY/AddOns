...
G.DefaultSettings = {
	...
	Misc = {
		...
		InfoStrRight = "[combat][spec][dura][gold][time]",
		InfoSize = 13,
		MaxAddOns = 12,
		MenuButton = true,
		QuickJoin = true,
...
G.OptionList = { -- type, key, value, name, horizon, doubleline
	...
	[3] = {
		...
		{1, "UFs", "CombatTextPet", L["CombatText ShowPets"].."*"},
		{3, "UFs", "FCTFontSize", L["FCTFontSize"].."*", true, {12, 40, 1}, updateScrollingFont},
		{1, "UFs", "CombatTextDamage", L["CombatText ShowDamage"].."*"},
		{1, "UFs", "CombatTextHeal", L["CombatText ShowHeal"].."*", true},
		{1, "UFs", "CombatTextMiss", L["CombatText ShowMiss"].."*"},
		{1, "UFs", "CombatTextEnv", L["CombatText ShowEnv"].."*", true},
	},
	[4] = {
		...
		{3, "UFs", "BuffIndicatorScale", L["BuffIndicatorScale"].."*", true, {.5, 1.5, .1}, updateRaidAurasOptions},
		{}, -- blank
		...
		{3, "UFs", "RaidDebuffScale", L["RaidDebuffScale"].."*", true, {.5, 1.5, .1}, updateRaidAurasOptions},
		{}, -- blank
	...
	[5] = {
		...
		{5, "Nameplate", "MouseoverColor", L["Mouseover Color"].."*"},
		...
		{3, "Nameplate", "MinAlpha", L["Nameplate MinAlpha"].."*", true, {.5, 1, .1}, updatePlateCVars},
	},
	[6] = {
	...
	[7] = {
		...
		{3, "AuraWatch", "IconScale", L["AuraWatch IconScale"], nil, {.5, 1.5, .1}},
	...
	[10] = {
		...
		{3, "Map", "MinimapSize", L["Minimap Size"].."*", nil, {100, 500, 1}, updateMinimapScale},
		{2, "ACCOUNT", "IgnoredButtons", L["IgnoredButtons"], true, nil, nil, L["IgnoredButtonsTip"]},
	...
	[13] = {
		...
		{1, "Misc", "MerchantConfirm", L["MerchantConfirm"], true},
