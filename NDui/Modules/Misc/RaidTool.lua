...
function M:RaidTool_Header()
	...
	frame:HookScript("OnEnter", function(self)
		...
		GameTooltip:AddLine(" ")
		GameTooltip:AddLine(DB.LeftButton..ACCESSIBILITY_LABEL, 0,1,1)
		GameTooltip:AddLine(DB.RightButton..L["BR Send"], 0,1,1)
		GameTooltip:Show()
	end)
...
function M:RaidTool_BuffChecker(parent)
	...
	frame:HookScript("OnEnter", function(self)
		...
		GameTooltip:AddLine(L["Raid Tool"], 0,1,1)
		GameTooltip:AddLine(" ")
		GameTooltip:AddLine(DB.LeftButton..L["Check Status"], 0,1,1)
		if potionCheck then
			GameTooltip:AddLine(DB.RightButton..L["MRT Potioncheck"], 0,1,1)
		end
		GameTooltip:Show()
	end)
	frame:HookScript("OnLeave", B.HideTooltip)
...
function M:RaidTool_CountDown(parent)
	...
	frame:HookScript("OnEnter", function(self)
		...
		GameTooltip:AddLine(L["Raid Tool"], 0,1,1)
		GameTooltip:AddLine(" ")
		GameTooltip:AddLine(DB.LeftButton..READY_CHECK, 0,1,1)
		GameTooltip:AddLine(DB.RightButton..L["Count Down"], 0,1,1)
		GameTooltip:Show()
	end)
	frame:HookScript("OnLeave", B.HideTooltip)
