	...
	PAPERDOLL_STATCATEGORIES = {
		[1] = {
			...
			stats = {
				...
				[4] = { stat = "STAMINA" },
				[5] = { stat = "ARMOR" },
				[6] = { stat = "ATTACK_AP", primary = LE_UNIT_STAT_STRENGTH, roles =  { Enum.LFGRole.Tank, Enum.LFGRole.Damage } },
				[7] = { stat = "ATTACK_DAMAGE", primary = LE_UNIT_STAT_STRENGTH, roles =  { Enum.LFGRole.Tank, Enum.LFGRole.Damage } },
				[8] = { stat = "ATTACK_ATTACKSPEED", primary = LE_UNIT_STAT_STRENGTH, roles =  { Enum.LFGRole.Tank, Enum.LFGRole.Damage } },
				[9] = { stat = "ATTACK_AP", primary = LE_UNIT_STAT_AGILITY, roles =  { Enum.LFGRole.Tank, Enum.LFGRole.Damage } },
				[10] = { stat = "ATTACK_DAMAGE", primary = LE_UNIT_STAT_AGILITY, roles =  { Enum.LFGRole.Tank, Enum.LFGRole.Damage } },
				[11] = { stat = "ATTACK_ATTACKSPEED", primary = LE_UNIT_STAT_AGILITY, roles =  { Enum.LFGRole.Tank, Enum.LFGRole.Damage } },
