...
function M:MissingStats()
	...
	PAPERDOLL_STATCATEGORIES = {
		[1] = {
			...
			stats = {
				[1] = { stat = "AGILITY", primary = LE_UNIT_STAT_AGILITY },
				[2] = { stat = "INTELLECT", primary = LE_UNIT_STAT_INTELLECT },
				[3] = { stat = "STRENGTH", primary = LE_UNIT_STAT_STRENGTH },
				[4] = { stat = "STAMINA" },
				[5] = { stat = "ARMOR" },
				[6] = { stat = "ATTACK_AP", hideAt = 0, primary = LE_UNIT_STAT_STRENGTH, roles =  { Enum.LFGRole.Tank, Enum.LFGRole.Damage } },
				[7] = { stat = "ATTACK_DAMAGE", hideAt = 0, primary = LE_UNIT_STAT_STRENGTH, roles =  { Enum.LFGRole.Tank, Enum.LFGRole.Damage } },
				[8] = { stat = "ATTACK_ATTACKSPEED", hideAt = 0, primary = LE_UNIT_STAT_STRENGTH, roles =  { Enum.LFGRole.Tank, Enum.LFGRole.Damage } },
				[9] = { stat = "ATTACK_AP", hideAt = 0, primary = LE_UNIT_STAT_AGILITY, roles =  { Enum.LFGRole.Tank, Enum.LFGRole.Damage } },
				[10] = { stat = "ATTACK_DAMAGE", hideAt = 0, primary = LE_UNIT_STAT_AGILITY, roles =  { Enum.LFGRole.Tank, Enum.LFGRole.Damage } },
				[11] = { stat = "ATTACK_ATTACKSPEED", hideAt = 0, primary = LE_UNIT_STAT_AGILITY, roles =  { Enum.LFGRole.Tank, Enum.LFGRole.Damage } },
				...
				[15] = { stat = "FOCUS_REGEN", hideAt = 0, primary = LE_UNIT_STAT_AGILITY },
				[16] = { stat = "RUNE_REGEN", hideAt = 0, primary = LE_UNIT_STAT_STRENGTH },
				[17] = { stat = "STAGGER", hideAt = 0, primary = LE_UNIT_STAT_AGILITY },
				[18] = { stat = "MOVESPEED" },
			},
		},
		[2] = {
			...
			stats = {
				...
				{ stat = "SPEED", hideAt = 0 },
				{ stat = "BLOCK", hideAt = 0, roles =  { Enum.LFGRole.Tank } },
				{ stat = "DODGE", hideAt = 0, roles =  { Enum.LFGRole.Tank } },
