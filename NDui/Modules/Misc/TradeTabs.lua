...
function M:TradeTabs_FilterIcons()
	local buttonList = {
		[1] = {"Atlas:Garr_Building-AddFollowerPlus", TRADESKILL_FILTER_HAS_SKILL_UP, C_TradeSkillUI.GetOnlyShowSkillUpRecipes, C_TradeSkillUI.SetOnlyShowSkillUpRecipes},
