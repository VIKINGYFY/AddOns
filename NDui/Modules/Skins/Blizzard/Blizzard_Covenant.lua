...
C.OnLoadThemes["Blizzard_CovenantPreviewUI"] = function()
	...
	infoPanel.Name:SetTextColor(1, 1, 0)
	infoPanel.Location:SetTextColor(1, 1, 1)
	infoPanel.Description:SetTextColor(1, 1, 1)
	infoPanel.AbilitiesFrame.AbilitiesLabel:SetTextColor(1, 1, 0)
	infoPanel.SoulbindsFrame.SoulbindsLabel:SetTextColor(1, 1, 0)
	infoPanel.CovenantFeatureFrame.Label:SetTextColor(1, 1, 0)
	...
	hooksecurefunc(CovenantPreviewFrame, "TryShow", function(self)
		if not self.bg then
			...
			self.Title.Text:SetTextColor(1, 1, 0)
