...
C.OnLoginThemes["LFGFrame"] = function()
	...
	B.CreateBG(LFDRoleCheckPopup)
	LFDRoleCheckPopup.Border:Hide()
	B.ReskinButton(LFDRoleCheckPopupAcceptButton)
	B.ReskinButton(LFDRoleCheckPopupDeclineButton)
	B.ReskinScroll(LFDQueueFrameSpecific.ScrollBar)
	B.ReskinScroll(LFDQueueFrameRandomScrollFrame.ScrollBar)
	B.ReskinDropDown(LFDQueueFrameTypeDropdown)
	B.ReskinButton(LFDQueueFrameFindGroupButton)
	B.ReskinButton(LFDQueueFramePartyBackfillBackfillButton)
	B.ReskinButton(LFDQueueFramePartyBackfillNoBackfillButton)
	B.ReskinButton(LFDQueueFrameNoLFDWhileLFRLeaveQueueButton)
	...
	B.CreateBG(LFGDungeonReadyDialog)
	B.StripTextures(LFGInvitePopup)
	B.CreateBG(LFGInvitePopup)
	B.StripTextures(LFGDungeonReadyStatus)
	B.CreateBG(LFGDungeonReadyStatus)
	...
	B.ReskinScroll(RaidFinderQueueFrameScrollFrame.ScrollBar)
	B.ReskinDropDown(RaidFinderQueueFrameSelectionDropdown)
	B.ReskinButton(RaidFinderFrameFindRaidButton)
	B.ReskinButton(RaidFinderQueueFrameIneligibleFrameLeaveQueueButton)
