...
info.onEnter = function(self)
	...
	GameTooltip:AddDoubleLine(SPECIALIZATION, SELECT_LOOT_SPECIALIZATION, 0,1,1, 0,1,1)
	...
	if info and info.name then
		GameTooltip:AddLine(" ")
		GameTooltip:AddDoubleLine(TALENT_FRAME_DROP_DOWN_TOOLTIP_EDIT, info.name, 0,1,1, 1,1,1)
	end
	...
	if C_SpecializationInfo.CanPlayerUsePVPTalentUI() then
		...
		if #pvpTalents > 0 then
			GameTooltip:AddLine(" ")
			GameTooltip:AddLine(PVP_TALENTS, 0,1,1)
	...
	GameTooltip:AddDoubleLine(" ", DB.LeftButton..L["SpecPanel"].." ", 1,1,1, 0,1,1)
	GameTooltip:AddDoubleLine(" ", DB.RightButton..L["Change Spec"].." ", 1,1,1, 0,1,1)
	GameTooltip:Show()
end
