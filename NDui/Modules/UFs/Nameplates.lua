...
function UF:UpdateNameplateSize()
	...
	if self.plateType == "NameOnly" then
		...
		self.Castbar.Time:SetPoint("RIGHT", self.Castbar, "BOTTOMRIGHT", 0, plateCBOffset)
		B.SetFontSize(self.Castbar.Text, CBTextSize)
		self.Castbar.Text:SetPoint("LEFT", self.Castbar, "BOTTOMLEFT", 0, plateCBOffset)
		...
		self.healthValue:SetPoint("RIGHT", self, "TOPRIGHT", 0, healthTextOffset)
