...
L["Reset your AuraWatch List?"] = "Are you sure to table.wipe all your groups of custom list?"
...
L["JunkMode Enabled"] = "|nClick to tag item as junk.|nIf 'Autosell Junk' enabled, these items would be sold as well.|nThe list is saved account-wide, and won't be in the export data.|nYou can hold CTRL+ALT and click to table.wipe the custom junk list."
...
L["Reset junklist warning"] = "Are you sure to table.wipe the custom junk list?"
...
L["BagSortTip"] = "|nIf you have empty slots after bag table.sort, please disable bags module, and turn off all bags filter in default ui containers."
...
L["PetTrashTip"] = "|nIn patch 9.1, you can buy 3 battle pets by using specific trash items. Keep this enabled, will table.sort these items into Collection Filter, and won't be sold by auto junk selling."
...
L["DescRoleTip"] = "|nIf checked, table.sort your party order by 'Damager Healer Tank' within growth direction.|n|nIf unchecked, table.sort your party order by 'Tank Healer Damager' within growth direction."
