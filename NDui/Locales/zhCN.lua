...
L["CustomNameColorTip"] = "|n禁用该选项后，可点击旁边 名字颜色 进行自定义。"
L["Mouseover Color"] = "指向高亮边框"
...
L["CombatText ShowEnv"] = "显示承受的环境伤害"
L["CombatText ShowMiss"] = "显示输出和承受的其他类型"
L["CombatText ShowHeal"] = "显示输出和承受的治疗"
L["CombatText ShowDamage"] = "显示输出和承受的伤害"
L["CombatText ShowPets"] = "显示宠物输出的治疗和伤害"
L["CombatText"] = "简易战斗信息"
...
L["iLvlToShow"] = "物品等级阈值"
L["iLvlToShowTip"] = "|n低于设置阈值的 装备 将自动归类在 垃圾 分类里，但不会自动出售。"
...
L["FilterTradegoods"] = "过滤制作材料"
L["FilterLegendary"] = "过滤传奇物品"
L["FilterCollection"] = "过滤藏品"
L["FilterFavourite"] = "过滤偏好物品"
L["FilterQuest"] = "过滤任务物品"
L["FilterFeature"] = "过滤版本特色"
L["FilterAuE"] = "过滤战团装绑"
L["FilterBoN"] = "过滤未绑定物品"
L["Max Rank"] = "最高等级"
...
L["Switch Mode"] = "切换模式"
L["CustomBD"] = "自定义边框颜色"
L["CustomBDColor"] = "边框颜色"
L["CustomBDColorTip"] = "|n启用该选项后，可点击旁边 边框颜色 进行自定义。|n|n禁用该选项后，默认为黑色。"
...
L["SpecialJunk"] = "关注特殊垃圾"
L["SpecialJunkTip"] = "|n一些特殊垃圾可以解锁成就或者兑换东西，启用此选项会把这些物品归类到藏品过滤中，不会被自动清理。"
...
L["BagSearchTip"] = "|n点击对背包进行搜索。|n你可以搜索物品的名字或者装备的部位和类型。|n输入boe可以直接搜索装绑，输入aoe搜索战团装绑，输入任务则搜索任务道具。|n输入资料片对应数字编号，搜索来自该资料片的物品。|n|n按ESC键清空输入框。"
...
L["InfobarStrTip"] = "|n根据你输入的字符组合对信息条进行排序:|n[guild] 公会|n[friend] 好友|n[ping] 延迟|n[fps] 帧数|n[zone] 地点|n[combat] 战斗时长|n[spec] 专精|n[dura] 耐久|n[gold] 金币|n[time] 时间|n|n你可以自行调整顺序，但是一个信息条只能被使用一次。|n注意单词的拼写及大小写，清空输入框将重置设置。"
L["BagsPerRow"] = "每列背包数量"
...
L["ShowHealth CP"] = "当前数值 | 百分比"
L["ShowHealth CM"] = "当前数值 | 总上限"
L["ShowHealth OC"] = "当前数值"
L["ShowHealth OP"] = "当前百分比"
L["ShowHealth OL"] = "损失数值"
L["ShowHealth LP"] = "损失百分比"
L["ShowHealth AC"] = "当期数值 + 吸收值"
...
L["BloodlustStr"] = "%s 效果结束，可以找机会开 %s。"
...
L["ChargesRemaining"] = "%s %s / %s 充能剩余 %s"
...
L["AccountDepositTip"] = "|n左键点击：存放所有战团绑定物品。|n右键点击：切换存放模式。|n当按钮边框高亮时，将存放可交易的材料。"