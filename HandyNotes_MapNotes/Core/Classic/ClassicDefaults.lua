...
ns.defaults = {
  ...
  profile = {
    ...
    -- Capital Professions
      ...
      showCapitalsProfessionDetection = true,
      showCapitalsAlchemy = false,
      showCapitalsEngineer = false,
      showCapitalsCooking = false,
      showCapitalsFishing = false,
      showCapitalsArchaeology = false,
      showCapitalsMining = false,
      showCapitalsJewelcrafting = false,
      showCapitalsBlacksmith = false,
      showCapitalsLeatherworking = false,
      showCapitalsSkinning = false,
      showCapitalsTailoring = false,
      showCapitalsHerbalism = false,
      showCapitalsInscription = false,
      showCapitalsEnchanting = false,
      showCapitalsFirstAid = false,
    ...
    -- Capital Minimap Professions
      ...
      showMinimapCapitalsProfessionDetection = true,
      showMinimapCapitalsAlchemy = false,
      showMinimapCapitalsEngineer = false,
      showMinimapCapitalsCooking = false,
      showMinimapCapitalsFishing = false,
      showMinimapCapitalsArchaeology = false,
      showMinimapCapitalsMining = false,
      showMinimapCapitalsJewelcrafting = false,
      showMinimapCapitalsBlacksmith = false,
      showMinimapCapitalsLeatherworking = false,
      showMinimapCapitalsSkinning = false,
      showMinimapCapitalsTailoring = false,
      showMinimapCapitalsHerbalism = false,
      showMinimapCapitalsInscription = false,
      showMinimapCapitalsEnchanting = false,
      showMinimapCapitalsFirstAid = false,
