...
L["Use the addon 'Prat', 'Chat Copy Paste' for example to then copy this link from the chat"] = "Utilice el complemento 'Prat', 'Chat Copy Paste' por ejemplo para luego copiar este enlace del chat"
...
L["Disables the display of all Blizzard Delves entrances on the zone map"] = "Desactiva la visualización de todas las entradas de profundidad de Blizzard en el mapa de zona"
...
L["Displays additional information for dungeons or raid icons. E.g. the number of bosses already killed"] = "Muestra información adicional para mazmorras o redadas. Por ejemplo, el número de jefes ya matados"
