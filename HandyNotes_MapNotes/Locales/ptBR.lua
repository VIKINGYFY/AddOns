...
L["< Shift Left Click to show map >"] = "< Para exibir o botão de mudança de cartão + para a esquerda >"
L["< Left Click to open Adventure Guide >"] = "< Para exibir o guia de aventura à esquerda -clicando >"
L["< Shift + Right Click add TomTom waypoint >"] = "< Shift + clique com o botão direito do mouse no waypoint add >"
...
L["Disables the display of all Blizzard Delves entrances on the zone map"] = "Desativa a exibição de todas as entradas de Imersão da Blizzard no mapa da zona"
...
L["If you disable these Blizzard icons, the zone map will no longer indicate whether a Delve is a Bountiful Delves"] = "Se você desativar esses ícones da Blizzard, o mapa da zona não indicará mais se uma Delve é uma Bountiful Delves"
L["Displays icons for delves entrances, these icons look different on the zone map so you can see which delve is bountiful when using the Blizzard icons"] = "Exibe ícones para entradas de mergulho, esses ícones parecem diferentes no mapa da zona para que você possa ver qual mergulho é abundante ao usar os ícones da Blizzard"
--0.1 profiles
...
L["Displays additional information for dungeons or raid icons. E.g. the number of bosses already killed"] = "Exibe informações adicionais para masmorras ou ataques. Por exemplo, o número de chefes já mortos"
