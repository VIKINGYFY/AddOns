...
L["Use the addon 'Prat', 'Chat Copy Paste' for example to then copy this link from the chat"] = "Utilisez l'addon 'Prat', 'Chat Copy Paste' par exemple pour ensuite copier ce lien depuis le chat"
