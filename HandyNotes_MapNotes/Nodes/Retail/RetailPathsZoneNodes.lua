        ...
        if db.activate.ZonePaths then
            ...
            if self.db.profile.showZoneKhazAlgar then
                ...
                if self.db.profile.showZonePaths then
                    ...
                    --nodes[2256][70582441] = { name = "", dnID = L["Path"], mnID = 2214, type = "PathRO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    ...
                    nodes[2256][66521977] = { name = "", dnID = L["Path"], mnID = 2214, type = "PathRU", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2256][23843044] = { name = "", dnID = L["Path"], mnID = 2215, type = "PathRO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    --nodes[2255][24722251] = { name = "", dnID = L["Path"], mnID = 2215, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    --nodes[2256][24722251] = { name = "", dnID = L["Path"], mnID = 2215, type = "PathLO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    ...
                    --nodes[2256][61840352] = { name = "", dnID = L["Path"], mnID = 2215, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
                    nodes[2256][64891374] = { name = "", dnID = L["Path"], mnID = 2215, type = "PathO", showInZone = true, showOnContinent = false, showOnMinimap = false }
