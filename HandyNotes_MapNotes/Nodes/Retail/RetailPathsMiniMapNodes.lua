        ...
        if db.activate.MiniMapPaths then
            ...
            if self.db.profile.showMiniMapKhazAlgar then
                ...
                if self.db.profile.showMiniMapPaths then
                    ...
                    minimap[2248][67333102] = { dnID = L["Passage"], name = "", mnID = 2214, type = "PathU", showInZone = false, showOnContinent = false, showOnMinimap = true }
                    minimap[2214][65707693] = { dnID = L["Passage"], name = "", mnID = 2248, type = "PathO", showInZone = false, showOnContinent = false, showOnMinimap = true }
                    minimap[2214][53414454] = { dnID = L["Passage"], name = "", mnID = 2248, type = "PathO", showInZone = false, showOnContinent = false, showOnMinimap = true }
