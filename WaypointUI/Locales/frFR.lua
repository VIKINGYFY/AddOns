...
L["Config - General - Title - Subtext"] = "Gestion des paramètres et préférences généraux."
...
L["Config - WaypointSystem - General - RightClickToClear - Description"] = "Désélectionne l'objectif en cours avec un clic droit de la souris."
L["Config - WaypointSystem - General - BackgroundPreview"] = "Aperçu de l'arrière-plan"
L["Config - WaypointSystem - General - BackgroundPreview - Description"] = "Réduit la visibilité lorsque le curseur de la souris passe par-dessus."
...
L["Config - Appearance - Title - Subtext"] = "Personnalisation de l'apparence (taille, couleur, opacité, ...) de l'interface."
...
L["Config - Audio - Customize - UseCustomAudio - Sound ID"] = "Écouter l'ID du son"
