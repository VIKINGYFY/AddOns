...
local ScrollView     = env.WPM:New("wpm_modules/ui-kit/primitives/scrollView")
...
function ScrollView:New(name, parent)
    name = name or "undefined"


    local scrollView = Frame:New("Frame", name, parent)
    ...
    local scrollFrame = Frame:New("ScrollFrame", "$parent.ScrollFrame", scrollView)
